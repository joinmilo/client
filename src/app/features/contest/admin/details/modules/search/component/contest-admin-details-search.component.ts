...
import { selectClicksStatistics, selectCtrStatistics, selectImpressionsStatistics, selectPositionsStatistics } from '../state/contest-admin-details-search.selectors';
...
export class ContestAdminDetailsSearchComponent implements OnInit {
  ...
  public ngOnInit(): void {
    this.activatedRoute.parent?.params.pipe(
      ...
      if (slug) {
        this.store.dispatch(ContestAdminDetailsSearchActions.init(
          slug,
          this.initPeriod,
          this.initInterval,
        ));
  ...
  public updatePeriod($contest: Period): void {
    this.store.dispatch(ContestAdminDetailsSearchActions.updatePeriod($contest));
  }

  public updateInterval($contest: IntervalFilter): void {
    this.store.dispatch(ContestAdminDetailsSearchActions.updateInterval($contest));
  }
